  ...
  return (
    <div className='start' id='skills'>
      ...
      <div>
        ...
        {/* STYLE */}
        <h1 className='text-[10px] font-thin text-neutral-600 tracking-[0.35em] font-sand uppercase mt-10 mb-3'>styling</h1>
        <div className='flex gap-3 items-center'>
          <div className='shadow-2xl shadow-blue-500 text-center p-5 border-b-2 border-blue-500'>
            <div className='w-[100px] h-[100px]'>
              <Image src={'/tailwind.png'} alt='' width={200} height={200} quality={100} />
            </div>
            <p className='font-bold text-sm mt-3 text-neutral-600'>Tailwind CSS</p>
          </div>
          <div className='shadow-2xl text-center p-5'>
            <div className='w-[100px] h-[100px]'>
          ...
          <div className='shadow-2xl text-center p-5'>
            ...
            <p className='font-bold text-sm mt-3 text-neutral-600'>Semantic UI</p>
          </div>
          <div className='shadow-2xl text-center p-5'>
            <div className='w-[100px] h-[100px]'>
        ...
        {/* BACKEND */}
        <h1 className='text-[10px] font-thin text-neutral-600 tracking-[0.35em] font-sand uppercase mt-10 mb-3'>BACKEND</h1>
        <div className='flex gap-3 items-center'>
          <div className='shadow-2xl shadow-blue-500 text-center p-5 border-b-2 border-blue-500'>
            <div className='w-[100px] h-[100px]'>
        ...
        {/* EXTRA */}
        <h1 className='text-[10px] font-thin text-neutral-600 tracking-[0.35em] font-sand uppercase mt-10 mb-3'>EXTRA</h1>
        <div className='flex gap-3 items-center'>
          <div className='shadow-2xl text-center p-5'>
            <div className='w-[100px] h-[100px]'>
